...
const perfumes = [
    ...
    new Perfume(41, "Oud Wood", "Tom Ford", "Unisex", "Amaderado", "Calido especiado"),
    ...
    new Perfume(48, "Althair", "Parfums de Marly", "Hombre", "Dulce", "Avainillado"),
    ...
    new Perfume(68, "Matcha Meditation", "Maison Martin Margiela", "Unisex", "Floral", "Verde"),
    ...
    new Perfume(76, "Cassiopea", "Tiziana Terenzi", "Unisex", "Dulce", "Frutal"),
    ...
    new Perfume(107, "Vanilla 28", "Kayali", "Mujer", "Avainillado", "Dulce"),
    new Perfume(108, "Virgin Island Water", "Creed", "Unisex", "Citrico", "Dulce"),
    new Perfume(109, "Layton Exclusif", "Parfums de Marly", "Unisex", "Amaderado", "Citrico")
];
